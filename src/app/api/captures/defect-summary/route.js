...
export async function GET(request) {
  try {
    ...
    const rows = await query(
      `SELECT cd.defect_id, d.defect_code, d.description AS defect_name, c.mandrel, c.sap_number_extrusion, SUM(cd.defect_count) AS total_malas
       ...
       GROUP BY cd.defect_id, d.defect_code, c.mandrel, c.sap_number_extrusion
